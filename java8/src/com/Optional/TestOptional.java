...
//            System.out.println(op.get());
//        }
//        Employee emp = op.orElse(new Employee("明凯", 18, 7777.77, Employee.Status.FREE));
//        System.out.println(emp);
    ...
    //4.map(Function f)：如果有值对其处理，并返回处理后的Optional，否则返回Optional.empty()
    //  flatMap(Function mapper)：与map类似，要求返回值必须是Optional
    @Test
    public void test4(){
        Optional<Employee> op = Optional.ofNullable(new Employee("明凯", 18, 7777.77, Employee.Status.FREE));
